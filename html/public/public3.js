...
/*window.isNebula = (window.navigator.userAgent.toString().toLowerCase().indexOf('CDII-Bucket'.toLowerCase()) != -1) ||
  (window.navigator.userAgent.toString().toLowerCase().indexOf('nebula') != -1)
window.isNotNebula = !window.isNebula*/
window.isNotNebula=window.navigator.userAgent.toString().toLowerCase().indexOf('cdii-bucket') == -1
