/**version for CQRCB app**/


window.csiiImageUrl = 'https://mcube-prod.oss-cn-hangzhou.aliyuncs.com/7D77E5C302225_default/1.0.0/images/';
...
function document_addEventListener(tag, callBack, is) {
  document.addEventListener(tag, callBack, is)
}
