...
function AlipayJSBridge_startupParams(paramCallBack) {
    AlipayJSBridgeReadyFun(function () {
        if (isPushWeb) {
            ...
            L(AlipayJSBridge.startupParams, '没有处理过的参数03');
            if (AlipayJSBridge.startupParams && AlipayJSBridge.startupParams != null) {
                ...
                L(JSON.stringify(AlipayJSBridge.startupParams),'合并后的数据');
                ...
                var res = AlipayJSBridge.startupParams;
                Object.keys(res).forEach(function (key) {
                    if(isJSONString(res[key])){
